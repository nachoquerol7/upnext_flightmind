...
(function () {
  ...
  /** @typedef {{ key: string, title: string, prefix: string, start: number, end: number, panel: string }} ModuleRange */

  /** @type {ModuleRange[]} */
  const RANGES = [
    { key: "M1", title: "M1 — FSM Transitions", prefix: "TC-FSM-", start: 1, end: 30, panel: "FsmGraphPanel" },
    { key: "M2", title: "M2 — Timeouts / temporal", prefix: "TC-TO-", start: 1, end: 10, panel: "FsmGraphPanel" },
    { key: "M3", title: "M3 — Integridad YAML / FSM", prefix: "TC-INT-", start: 1, end: 12, panel: "FsmGraphPanel" },
    { key: "M4", title: "M4 — Histéresis / umbrales", prefix: "TC-HYS-", start: 1, end: 7, panel: "FsmGraphPanel" },
    { key: "M5", title: "M5 — Localización / quality", prefix: "TC-LOC-", start: 1, end: 13, panel: "MapPanel" },
    { key: "M6", title: "M6 — DAIDALUS / DAA", prefix: "TC-DAI-", start: 1, end: 12, panel: "RadarPanel" },
    { key: "M7", title: "M7 — FDIR / watchdog", prefix: "TC-FDIR-", start: 1, end: 16, panel: "WatchdogPanel" },
    { key: "M8", title: "M8 — Navegación / Nav2", prefix: "TC-NAV-", start: 1, end: 12, panel: "MapPanel" },
    { key: "M9", title: "M9 — Middleware ROS2", prefix: "TC-MW-", start: 1, end: 10, panel: "LatencyPanel" },
    { key: "M10", title: "M10 — E2E nominal", prefix: "TC-E2E-", start: 1, end: 10, panel: "E2EPanel" },
    { key: "M11", title: "M11 — Fallos / recuperación", prefix: "TC-FAULT-", start: 1, end: 12, panel: "E2EPanel" },
    { key: "M12", title: "M12 — Rendimiento", prefix: "TC-PERF-", start: 1, end: 8, panel: "LatencyPanel" },
    { key: "GPP-M1", title: "GPP-M1 — Flight levels", prefix: "TC-FL-", start: 1, end: 13, panel: "MapPanel" },
    { key: "GPP-M2", title: "GPP-M2 — Geometría / corridor", prefix: "TC-GEO-", start: 1, end: 12, panel: "MapPanel" },
    { key: "GPP-M3", title: "GPP-M3 — Dubins", prefix: "TC-DUB-", start: 1, end: 11, panel: "MapPanel" },
    { key: "GPP-M4", title: "GPP-M4 — Informed-RRT*", prefix: "TC-RRT-", start: 1, end: 12, panel: "MapPanel" },
    { key: "GPP-M5", title: "GPP-M5 — Planificación temporal", prefix: "TC-GTO-", start: 1, end: 12, panel: "MapPanel" },
    { key: "GPP-M6", title: "GPP-M6 — Nodos / grafo", prefix: "TC-NODE-", start: 1, end: 10, panel: "MapPanel" },
    { key: "GPP-M7", title: "GPP-M7 — Integración GPP", prefix: "TC-GPPI-", start: 1, end: 5, panel: "MapPanel" },
    { key: "GPP-M8", title: "GPP-M8 — Requisitos SR-GPP", prefix: "SR-GPP-", start: 1, end: 8, panel: "MapPanel" },
    { key: "AUX", title: "AUX — Cobertura plan maestro", prefix: "TC-AUX-", start: 1, end: 17, panel: "FsmGraphPanel" },
  ];
